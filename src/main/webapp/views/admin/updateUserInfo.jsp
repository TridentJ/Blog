                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                <div class=" col-sm-10 col-sm-offset-2">
                                    <button type="button" class="btn btn-primary col-sm-2 col-offset-sm-2" onclick="updateUserInfo();"><i class="icon-save"></i> 提交</button>
                                    <button type="button" class="btn btn-primary col-sm-2 col-sm-offset-1" onclick="updateUserInfo2();"><i class="icon-save"></i> 提交json</button>
                                </div>
                            </div>
                        </form>
                    </div>
