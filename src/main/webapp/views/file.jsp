                ...
                <section class="wrapper">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-offset-3 col-sm-5">
                                    ...
                                    <input type="text" id="search-input" value="" placeholder="搜索知识库" class="form-control">
                                </div>
                                <div class="col-sm-1">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <section class="panel">
                                <br/>
                                <h4>&nbsp;&nbsp;&nbsp;&nbsp;下载库:<span class="red" id="search-keyword"></span></h4>
                                ...
                                <div class="panel-body" >
                                    ...
                                    --%>
                                    <ul>
                                        <li><a href="download.htm?fileName=1.pdf">构架.pdf</a></li>
                                        <li><a href="download.htm?fileName=全流程安全管控方案.docx">全流程安全管控方案.docx</a></li>
                                    </ul>
